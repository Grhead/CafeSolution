...
public partial class OrderCardAdmin : Page
{
    ...
    private void ButtonBase_OnClick(object sender, RoutedEventArgs e)
    {
        ...
        CookEndPoints newCook = new CookEndPoints();
        newAdmin.ChangeOrderDetails(Navigation.selectedOrder.Id, Convert.ToInt32(TextBoxCustomersCount.Text), (int)ComboBoxTableNumber.SelectionBoxItem,  newCook.GetDishId(ComboBoxStatuses.SelectionBoxItem.ToString()));
    }
